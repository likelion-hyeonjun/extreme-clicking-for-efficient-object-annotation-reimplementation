...
import json
SPLITS = ['val', 'train']
ANN_PATH = '/data02/hyeonjun1882/VOC_dataset/annotations/voc_2012_{}.json'
OUT_PATH = '/data02/hyeonjun1882/VOC_dataset/annotations/voc_2012_extreme_{}.json'
IMG_DIR = '/data02/hyeonjun1882/VOC_dataset/{}/'
DEBUG = False
